    ...
    switch (step) {
      ...
      case 'config':
        return !isAuthenticated ? 'disabled' : 
               isStorageConfigured() ? 'completed' : 'current';
      case 'complete':
    ...
    switch (currentStep) {
      ...
      case 'auth':
        return (
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              To store your data in GitHub, we need access to your repositories. 
              This allows us to create and update files in the repository you specify.
            </p>
        ...
        return (
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              ...
              You can specify the repository, branch, and folder structure.
            </p>
