...
export function QuickSyncSection() {
    ...
    console.log('[QuickSyncSection] syncStatus', { syncStatus, isGitHubEnabled, isAuthenticated, isStorageConfigured });

    console.log('[QuickSyncSection] isGitHubEnabled', { isGitHubEnabled, isAuthenticated, isStorageConfigured });
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg border border-green-200 dark:border-green-700 bg-white dark:bg-gray-800">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600 dark:text-gray-400">{formatLastSync(lastSyncTime)}</span>
                    </div>
                    {lastSyncTime && (
                ...
                <div className="text-xs text-green-700 dark:text-green-300 space-y-1">
                    <p>💡 <strong>Quick Sync Tips:</strong></p>
