import { formatTimeForSocial, formatFullTime, formatRelativeTime, formatSmartTime } from "@/common/lib/time-utils";
        ...
        <div className="space-y-6">
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-900/20 rounded-lg border border-slate-200 dark:border-slate-800">
                ...
                <div className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                    <p><strong>formatTimeForSocial:</strong> Perfect for message timestamps in chat interfaces</p>
                    <p><strong>formatFullTime:</strong> Use when you need complete time context</p>
                    <p><strong>formatRelativeTime:</strong> Always shows relative time, good for activity feeds</p>
                    <p><strong>formatSmartTime:</strong> Automatically adapts based on time difference</p>
                </div>
            </div>
        </div>
    );
