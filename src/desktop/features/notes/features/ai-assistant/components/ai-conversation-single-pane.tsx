...
export const AIConversationSinglePane = forwardRef<SinglePaneRef, ConversationPaneProps>(
  function AIConversationSinglePane(
    { conversations, currentConversationId, loading, channelId, onClose },
    ref
  ) {
