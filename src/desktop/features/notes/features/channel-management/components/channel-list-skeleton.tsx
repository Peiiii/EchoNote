...
export function ChannelListSkeleton({ count = 12 }: ChannelListSkeletonProps) {
  return (
    <div
      ...
      className="w-full h-full overflow-hidden flex flex-col bg-card shadow-sm"
    >
      {/* Header */}
      <div
      ...
      >
        {Array.from({ length: count }).map((_, index) => (
          <div key={index} className="w-full group transition-all duration-200 cursor-pointer">
      ...
      {/* Footer Skeleton */}
      <div
        data-component="channel-list-footer"
