...
import { useNotesViewStore as notesViewStore, useNotesViewStore } from "@/core/stores/notes-view.store";
...
export function NotesPage() {
  ...
  useHandleRxEvent(rxEventBusService.requestJumpToMessage$, ({ channelId, messageId }) => {
