...
export const Loading: React.FC<LoadingProps> = ({
  ...
  const renderRipple = () => (
    <div className="relative">
      ...
      />
      <div
        className={cn("relative rounded-full bg-blue-600 dark:bg-blue-400", sizeClasses[size])}
      />
    </div>
  );
  ...
  return <div className={cn("flex items-center justify-center", className)}>{renderContent()}</div>;
};
