 ...
 */
    private async validateAccess(): Promise<void> {
        ...
        try {
            ...
            throw new Error(`Cannot access repository ${this.config.owner}/${this.config.repo}, please check permissions`);
        }
    }
 ...
 */
    ...
    async getBranches() {
        ...
        try {
            ...
            throw new Error(`Failed to get branch list: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
}
