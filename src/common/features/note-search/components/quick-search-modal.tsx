  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) setOpen(false); }}>
      <DialogContent
        ...
        className="flex flex-col p-0 w-screen max-w-none h-svh top-0 left-0 translate-y-0 translate-x-0 rounded-none border-0 sm:rounded-lg sm:h-auto sm:w-[96vw] sm:max-w-2xl sm:top-[8vh] sm:left-1/2 sm:translate-y-0 sm:translate-x-[-50%] sm:max-h-[80vh]"
      >
        ...
        <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b">
              ...
              <div className="text-xs text-muted-foreground">
                {scope === 'all' ? (
                  ...
                  <span className="text-muted-foreground/90">
                    Searching in <span className="font-medium text-foreground">{channelName(currentChannelId || '') || 'current space'}</span>
                  </span>
                )}
              </div>
              <div className="shrink-0">
                <div role="radiogroup" aria-label="Search scope" className="inline-flex items-center rounded-md border bg-muted p-0.5">
                  <button
                    role="radio"
          ...
          {/* Status indicator moved to Row 2 above to avoid duplication */}
        </div>
        ...
        >
          {!q ? (
            <div className="flex-1 flex flex-col items-center justify-center py-16 px-4 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">Type to search across {scope === 'current' ? 'current space' : 'all spaces'}</p>
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-16 px-4 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">Try different keywords or search in all spaces</p>
              <button
