    ...
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        <div className="mb-4">
          ...
          <h3 className="text-xl font-semibold mb-2">{t('aiAssistant.emptyPane.title')}</h3>
          <p className="text-muted-foreground text-sm leading-relaxed">
            {t('aiAssistant.emptyPane.description')}
          </p>
        </div>
        
        <div className="space-y-3 mb-6">
          <div className="text-xs text-muted-foreground space-y-1">
            <p className="font-medium">{t('aiAssistant.emptyPane.tryAsking')}</p>
            <p>"{t('aiAssistant.emptyPane.example1')}"</p>
            <p>"{t('aiAssistant.emptyPane.example2')}"</p>
            <p>"{t('aiAssistant.emptyPane.example3')}"</p>
          </div>
        </div>
        ...
        >
          {t('aiAssistant.emptyPane.startConversation')}
        </button>
      </div>
    </div>
  );
