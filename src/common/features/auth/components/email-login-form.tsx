...
import {
    AuthStep,
    AuthMessage,
    AuthProgress as AuthProgressEnum,
...
/**
 * Pure email login form component.
 * Handles email/password login, registration, password reset, and email verification.
 * Does NOT include social login options - those are handled by LoginMethodSelector.
 */
export const EmailLoginForm = ({ className }: EmailLoginFormProps) => {
