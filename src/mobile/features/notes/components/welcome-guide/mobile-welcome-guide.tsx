            ...
            <div className="max-w-sm w-full space-y-6 text-center">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        ...
                        Create your first thought space to get started.
                    </p>
                </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3 text-left">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Create dedicated spaces for different topics</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 text-left">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Capture inspiration and brainstorm solutions</p>
                        </div>
                    </div>
                </div>
