    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-foreground">{t("threadManagement.sidebar.title")}</h3>
        </div>
          <Button
            variant="ghost"
            size="icon"
      ...
      <div className="p-4 bg-muted/50">
        <div className="text-sm text-muted-foreground mb-2">{t("threadManagement.sidebar.parentMessage")}</div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        <div className="text-sm font-medium text-foreground mb-3">{t("threadManagement.sidebar.replies")}</div>
        {threadMessages.length === 0 ? (
          <div className="text-sm text-muted-foreground text-center py-8">
            {t("threadManagement.sidebar.noRepliesMobile")}
          </div>
        ) : (
      ...
      <div className="p-4">
        <div className="flex gap-2">
          <input
            type="text"
            placeholder={t("threadManagement.sidebar.replyToThread")}
          ...
          >
            {t("threadManagement.sidebar.reply")}
          </Button>
        </div>
      </div>
    </div>
